...
from modules.extractor.TextNode import TextNode


class ExtractorMiddleNode:
    def __init__(self):
        super().__init__()
    ...
    def create_text_node_list(self, source):
        dom, s_text = self.__dom_create(source)
